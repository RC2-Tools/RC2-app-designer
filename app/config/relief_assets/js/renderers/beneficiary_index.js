...
beneficiaryIndex.display = function() {
    ...
    if (util.getWorkflowMode() === util.workflow.idOnly) {
        registerBtn.onclick = function () {
            odkTables.launchHTML(null, 'config/relief_assets/html/choose_location.html');
        };
    } else {
        registerBtn.onclick = function() {
            odkTables.launchHTML(null, 'config/relief_assets/html/registration.html');
        };
    }
    ...
    document.getElementById('visit').onclick = function() {
        odkTables.launchHTML(null, 'config/relief_assets/html/visit.html');
    };

    document.getElementById('data').onclick = function() {
        odkTables.launchHTML(null,
                             'config/relief_assets/html/data_start.html');
    };
    ...
    if (util.getWorkflowMode() === util.workflow.idOnly) {
        ...
        return util.renderSuperuserFeatures(function() {
            document.getElementById('overrides').onclick = function() {
                odkTables.launchHTML(null, 'config/relief_assets/html/overrides_start.html');
            };
        });
    }
};
